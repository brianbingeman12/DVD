...
/****** Object:  Database [DVD]    Script Date: 9/19/2017 1:56:17 PM ******/
CREATE DATABASE [DVD]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'DVD', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\DVD.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'DVD_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.MSSQLSERVER\MSSQL\DATA\DVD_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [DVD] SET COMPATIBILITY_LEVEL = 130
GO
...
ALTER DATABASE [DVD] SET RECOVERY FULL 
GO
...
ALTER DATABASE [DVD] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO

ALTER DATABASE [DVD] SET DELAYED_DURABILITY = DISABLED 
GO

ALTER DATABASE [DVD] SET QUERY_STORE = OFF
GO
